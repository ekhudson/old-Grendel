...
public class Trigger : EditorObject, IEditorObject 
{
	...
	IEnumerator ScrubList()
	{
		while(true)
		{
			foreach(Collider other in ObjectList)
			{
				if (other != null)
				{
					EventManager.Instance.Post(this, new TriggerEventStay(other, this));
					continue;
				}
				else
				{
	...
	{		
		EventManager.Instance.Post(this, new TriggerEventEnter(collider, this));
	...
	{	
		EventManager.Instance.Post(this, new TriggerEventExit(collider, this));		
